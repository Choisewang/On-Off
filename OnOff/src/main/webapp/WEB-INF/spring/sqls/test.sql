...
INSERT INTO USERINFO VALUES('1','1','일반회원','회원','1996-08-24','1@GAMIL.COM','강남','W','01034785503',SYSDATE);
INSERT INTO USERINFO VALUES('2','2','일반회원','이름2','1996-08-24','1@GAMIL.COM','강남','W','01034785503',SYSDATE);
INSERT INTO USERINFO VALUES('3','3','일반회원','이름3','1996-08-24','1@GAMIL.COM','강남','W','01034785503',SYSDATE);
...
INSERT INTO GROUPINFO VALUES(GROUPSEQ.NEXTVAL,'제목입니다4','내용입니다4',SYSDATE,'sample_koala');
INSERT INTO GROUPINFO VALUES(GROUPSEQ.NEXTVAL,'제목입니다2','내용입니다2',SYSDATE,'sample_koala');
INSERT INTO GROUPINFO VALUES(GROUPSEQ.NEXTVAL,'제목입니다3','내용입니다3',SYSDATE,'sample_koala');

--SELECT * FROM GROUPINFO;
--SELECT * FROM GROUPUSER;

--UPDATE GROUPUSER SET GROUPUSERGRADE='MASTER' WHERE USERID='1' AND GROUPNO='2';
--가입한 그룹 뽑기
--SELECT GROUPNO,GROUPTITLE,GROUPCONTENT,GROUPREGDATE,GROUPIMG
--FROM GROUPINFO
--WHERE GROUPNO IN(SELECT GROUPNO FROM GROUPUSER WHERE USERID='1' AND GROUPUSERGRADE !='MASTER');
--MASTER만 뽑기
--SELECT GROUPNO,GROUPTITLE,GROUPCONTENT,GROUPREGDATE,GROUPIMG
--FROM GROUPINFO
--WHERE GROUPNO IN(SELECT GROUPNO FROM GROUPUSER WHERE  GROUPUSERGRADE='MASTER');
